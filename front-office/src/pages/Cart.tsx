...
export const CartTop: React.FC<{
  cartItems: any[];
  handleDelete: (orderItemId: number) => void;
}> = ({ cartItems, handleDelete }) => {
  return (
    <>
      <div className="max-w-screen-2xl mx-auto my-3" style={{ width: "68%" }}>
        <h3 className="text-2xl font-medium text-center mb-6 my-10">
          ショッピングカート
        </h3>
...
}> = ({ totalPrice, tax, handleProceedToOrder }) => {
  return (
